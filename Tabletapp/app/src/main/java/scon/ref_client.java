...
public class ref_client {
	...
	public static void main() {
        ...
        User user = new User(username, password, url, 0);
		...
		try {
            ...
            LinkedList<Entry_Remote_Identifier> remoteEntry_list = SDS.get_last_entry_references(remoteExperiment_list.getFirst().getProject_id(), 10, null);
            ...
            new_entry_info = SDS.send_entry(remoteExperiment_list.getFirst().getId(), new Long(10), "Ref Client Test Entry Text", attachment);
            ...
            new_entry_info = SDS.send_entry(remoteExperiment_list.getFirst().getId(), new Long(20), "Ref Client Test Entry Table", attachment);
            System.out.println(new_entry_info.getId());
            System.out.println(new_entry_info.getLast_change());
          ...
          for (Entry_Remote_Identifier b: remoteEntry_list) {
                a = SDS.get_entry(b);
                System.out.println(a.getExperiment_id());
                System.out.println(a.getTitle());
                c = AttachmentBase.deserialize(a.getAttachment_type(), a.getAttachment_ser());
